...
(function(root){
  const fr={
    ...
    "Crypto assets with a valid return in the current market snapshot form the reference, including stablecoins. Changing your watchlist or filtering the map does not change this reference. At least 20 valid observations are required.":"Les actifs crypto ayant une performance valide dans l’instantané forment la référence, stablecoins compris. Modifier vos favoris ou filtrer la carte ne change pas cette référence. Au moins 20 observations valides sont nécessaires.",
    "A price return more than two standard deviations from the reference mean, or unusually high 24-hour volume relative to market cap. The reference includes crypto assets with usable data, not just your favorites.":"Une performance éloignée de plus de deux écarts-types de la moyenne de référence, ou un volume sur 24 heures inhabituellement élevé par rapport à la capitalisation. La référence inclut les actifs crypto aux données exploitables, pas seulement vos favoris.",
    'Orbit2 - crypto watchlist':'Orbit2 - favoris crypto',
    'Crypto. Your market view.':'Crypto. Votre vue du marché.',
