...
(function(root){
  const fr={
    ...
    'Build my watchlist':'Choisir mes actifs','Open my watchlist':'Ouvrir mes favoris','Explore market':'Explorer le marché',
    ...
    'On this device, in your browser. Up to 50 assets, without an account. Your selection is not sent to the server. A local JSON export is available for backup or transfer.':'Sur cet appareil, dans votre navigateur. Jusqu’à 50 actifs, sans compte. Votre sélection n’est pas envoyée au serveur. Un export JSON local permet de la sauvegarder ou de la transférer.',
    ...
    'View':'Vue','Watchlist':'Favoris','Market':'Marché','Performance period':'Période de performance','Show':'Afficher','All assets':'Tous les actifs',
    ...
    'Find an asset':'Rechercher un actif','Open watchlist':'Ouvrir les favoris','On this device only. No account.':'Sur cet appareil uniquement. Sans compte.',
    'Asset performance heatmap':'Carte des performances des actifs','Waiting for data':'En attente de données','Assets':'Actifs','Loading market data':'Chargement des données de marché',
    'Show all assets':'Afficher tous les actifs','24-hour performance':'Performance sur 24 heures','Down':'Baisse','Up':'Hausse','In your watchlist':'Dans vos favoris','In the top 100':'Dans le top 100',
    ...
    'Private by design':'Vie privée préservée','Legal & privacy':'Mentions légales et vie privée','Source / MIT':'Code / MIT','Your assets':'Vos actifs','Close':'Fermer',
    'Search assets':'Rechercher des actifs','Selected only':'Sélection uniquement','More assets':'Plus de actifs','Done':'Terminer','Export watchlist':'Exporter les favoris',
    'Assets and display preferences':'Cryptos et préférences d’affichage','From an Orbit2 JSON file':'Depuis un fichier JSON Orbit2',
    ...
    'Selection':'Sélection','Merge with my assets':'Fusionner avec mes actifs','Replace my selection':'Remplacer ma sélection','Import':'Importer',
    ...
    '7D':'7J','30D':'30J','{n} asset':'{n} actif',
    'Your watchlist is limited to 50 assets.':'Les favoris sont limités à 50 actifs.',
    ...
    'Your selection':'Votre sélection','Market preview':'Aperçu du marché','{n} assets':'{n} actifs',' · {n} unavailable':' · {n} indisponibles',' · mean {value}':' · moyenne {value}',
    '{period} performance · USD':'Performance sur {period} · USD','{n} of 50 selected':'{n} sur 50 sélectionnés','{n} / 50 selected':'{n} / 50 sélectionnés',
    ...
    'Your signals start here':'Vos signaux commencent ici','Choose the assets you want to follow.':'Choisissez les actifs à suivre.','Signals unavailable':'Signaux indisponibles',
    ...
    'A little more focus.':'Un peu plus de recul.','Your chosen assets will appear here.':'Vos actifs apparaîtront ici.','Market data unavailable':'Données de marché indisponibles',
    'We will retry automatically. Your watchlist is kept.':'Nouvelle tentative automatique. Vos favoris sont conservés.','No matching assets':'Aucun actif correspondant',
    'Nothing in this selection matches the current filter.':'Aucun actif de cette sélection ne correspond au filtre.','Selected assets unavailable':'Actifs sélectionnés indisponibles',
    ...
    'Add {name}':'Ajouter {name}','Remove {name}':'Retirer {name}','Loading assets...':'Chargement des actifs…','Market data is unavailable.':'Les données de marché sont indisponibles.',
    'No selected assets match.':'Aucun favori correspondant.','No matching asset in the current feed.':'Aucun actif correspondant dans les données actuelles.',
    ...
    'Watchlist files must be smaller than 16 KB.':'Le fichier de favoris doit peser moins de 16 Ko.','{n} assets in this file. Display preferences will also be restored.':'{n} actifs dans ce fichier. Les préférences d’affichage seront aussi restaurées.',
    '{n} assets after import':'{n} actifs après import',' · {n} currently unavailable; identifiers will be kept.':' · {n} actuellement indisponibles ; les identifiants seront conservés.',
    ...
    'File exceeds 16 KB':'Le fichier dépasse 16 Ko','Invalid JSON file':'Fichier JSON invalide','Expected an Orbit2 watchlist with up to 50 assets':'Un fichier de favoris Orbit2 contenant au plus 50 actifs est requis','Invalid asset identifier':'Identifiant d’actif invalide','This selection exceeds 50 assets':'Cette sélection dépasse 50 actifs',
    ...
    'Collection every ~{n} min · quotes may be delayed':'Collecte toutes les ~{n} min · cotations éventuellement différées',
    'Provider pause · retry after {date}':'Pause du fournisseur · reprise après {date}',
    'Collection interrupted · last received quotes shown.':'Collecte interrompue · dernières cotations reçues affichées.',
    'Collection interrupted · last received quote.':'Collecte interrompue · dernière cotation reçue.',
    'Provider quote older than 10 min.':'Cotation du fournisseur de plus de 10 min.',
    'Delayed quote.':'Cotation différée.',
    'Last quoted price.':'Dernier prix coté.',
    'Quote timestamp unavailable or invalid.':'Date de cotation indisponible ou invalide.',
    'Quoted {age}':'Cotation : {age}',
    'Details':'Détails','Hide details':'Masquer les détails','Crypto {value}':'Crypto {value}',
    'Older data · last available quotes shown.':'Données anciennes · derniers prix disponibles affichés.',
    'Top {n} · {total} xStocks in the catalog':'Top {n} · {total} xStocks au catalogue',
    '{n} older quotes':'{n} prix anciens',
    "Orbit2 - crypto & xStocks watchlist":"Orbit2 - favoris crypto et xStocks",
    "Crypto & xStocks. Your market view.":"Crypto et xStocks. Votre vue du marché.",
    "Your assets. The market around them. A clearer perspective on everyday price moves, unusual activity and the gaps between them.":"Vos actifs. Le marché qui les entoure. Un regard plus clair sur les variations de prix, l’activité inhabituelle et les écarts entre les deux.",
    "Asset class":"Classe d’actifs",
    "All assets":"Tous les actifs",
    "Crypto market":"Marché crypto",
    "Stocks & ETFs, tokenized":"Actions et ETF tokenisés",
    "Crypto and xStocks, in one watchlist.":"Crypto et xStocks, dans les mêmes favoris.",
    "Token prices · separate from the crypto signals":"Prix des tokens · distincts des signaux crypto",
    "xStocks data: {state}":"Données xStocks : {state}",
    "Follow token prices and add xStocks to the same watchlist as your crypto.":"Suivez le prix des tokens et retrouvez vos xStocks aux côtés de vos cryptos.",
    "In the feed":"Actifs disponibles",
    "Currency":"Devise",
    "Token capitalization is not the value of the underlying company.":"La capitalisation du token ne représente pas la valeur de l’entreprise sous-jacente.",
    "Crypto context":"Contexte crypto",
    "Tokenized markets":"Marchés tokenisés",
    "Price tracking":"Suivi des prix",
    "CoinGecko · token market data":"CoinGecko · marché des tokens",
    "A separate market":"Un marché distinct",
    "xStocks are outside the crypto reference. Price, performance and volume remain available in each asset sheet.":"Les xStocks sont exclus de la référence crypto. Prix, performance et volume sont consultables dans chaque fiche.",
    "A token provides economic exposure, without shareholder voting rights.":"Le token donne une exposition économique, sans droit de vote d’actionnaire.",
    "{n} xStocks tracked separately from crypto signals":"{n} xStocks suivis séparément des signaux crypto",
    "xStocks are outside the crypto reference":"Les xStocks sont exclus de la référence crypto",
    "xStocks unavailable":"xStocks indisponibles",
    "The xStocks feed is unavailable. Please try again later.":"Les données xStocks sont indisponibles. Réessayez plus tard.",
    "Older quote":"Prix ancien",
    "Older quote · this price is not current.":"Prix ancien · cette cotation n’est pas à jour.",
    "Token market data. Economic exposure to a stock or ETF, without shareholder voting rights.":"Données du token. Exposition économique à une action ou à un ETF, sans droit de vote d’actionnaire.",
    "xStocks documentation":"Documentation xStocks",
    "Token market data":"Marché du token",
    "Token market cap":"Capitalisation du token",
    "Token volume · 24H":"Volume du token · 24H",
    "A crypto reference":"Une référence crypto",
  ...
  function apply(){
    ...
    document.querySelectorAll('[data-docs]').forEach(a=>a.setAttribute('href',a.dataset.docs+(language==='fr'?'docs/':'docs/en/')));
  }
