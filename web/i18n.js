...
(function(root){
  const fr={
    'Snapshot context':'Contexte du marché','Market context':'Contexte de marché','Market median':'Médiane du marché','Assets rising':'Actifs en hausse',
    '{up} rising, {flat} unchanged, {down} falling':'{up} en hausse, {flat} inchangés, {down} en baisse',
    '{n} / {total} assets · stablecoins included':'{n} / {total} actifs · stablecoins compris',
    '{dated} / {n} observation times supplied':'{dated} / {n} heures d’observation fournies',
    'Collection time does not establish when a provider observed a price.':'L’heure de collecte ne permet pas de déterminer quand le fournisseur a observé le prix.',
    'vs BTC':'face au BTC','vs market median':'face à la médiane','pp':'pts',
    'Relative return, not a percentage-point difference.':'Performance relative, pas un écart en points de pourcentage.',
    'Difference from the market median, in percentage points.':'Écart à la performance médiane du marché, en points de pourcentage.',
    'Collection only · observation time unknown':'Collecte seule · heure d’observation inconnue','Dated asset price':'Prix de l’actif horodaté',
    'Bitcoin observation time unknown':'Heure d’observation du Bitcoin inconnue',
    'Bitcoin is absent from the snapshot':'Le Bitcoin est absent de l’instantané',
    'Asset or Bitcoin observation is invalid or stale':'Observation de l’actif ou du Bitcoin invalide ou trop ancienne',
    'Comparable returns unavailable':'Performances comparables indisponibles',
    'Observation times differ by more than one minute':'Les heures d’observation diffèrent de plus d’une minute',
    'Asset observation time is invalid':'L’heure d’observation de cet actif est invalide',
    'Snapshot comparisons, not independent confirmations or forecasts.':'Comparaisons instantanées, pas des confirmations indépendantes ni des prévisions.',
    'Relative comparisons':'Comparaisons relatives',
    'The market median is the middle return of the usable reference, not a market-cap-weighted index. Breadth counts rising, unchanged and falling assets over the selected period, with equal weight per asset. Stablecoins and correlated tokens remain included; this is not a sector-matched comparison.':'La médiane du marché est la performance centrale de la référence exploitable, pas un indice pondéré par la capitalisation. La participation dénombre les actifs en hausse, inchangés et en baisse sur la période choisie, à poids égal. Stablecoins et jetons corrélés restent inclus : ce n’est pas une comparaison sectorielle.',
    'Against BTC: 100 × ((100 + asset return %) / (100 + BTC return %) - 1), for the same period. Against the median: asset return minus median return, in percentage points. These comparisons add context, not independent confirmations or predictions.':'Face au BTC : 100 × ((100 + performance de l’actif %) / (100 + performance du BTC %) - 1), sur la même période. Face à la médiane : performance de l’actif moins performance médiane, en points de pourcentage. Ces comparaisons apportent du contexte, pas des confirmations indépendantes ni des prévisions.',
    'Missing or invalid BTC returns suppress the relative comparison, as does a BTC return of -100%. Supplied observation times must be current and at most one minute apart. Collection-only snapshots remain explicitly labelled: synchronisation cannot be verified without observation times.':'Une performance BTC manquante, invalide ou égale à -100 % désactive la comparaison relative. Les heures d’observation fournies doivent être récentes et espacées d’au plus une minute. Les instantanés ne fournissant qu’une heure de collecte sont signalés : sans heures d’observation, leur synchronisation ne peut pas être vérifiée.',
    'Invalid supplied timestamps are excluded. Observation coverage describes data availability, not a confidence score. No signal history or visitor tracking is stored. Only favorites, display preferences and language are saved locally in your browser.':'Les horodatages fournis mais invalides sont exclus. La couverture des observations décrit la disponibilité des données, pas un score de confiance. Aucun historique des signaux ni suivi des visiteurs n’est enregistré. Seuls les favoris, les préférences d’affichage et la langue sont conservés localement dans votre navigateur.',
